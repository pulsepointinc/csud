 ...
 *      url: 'http://bidder.com/vm2/userDataProvider.html',
 *      timeout: 75,
 ...
 *      timeout: 100,
 *      partners: {
 *          'dbm': { url: '//dbm.com/vm2/userDataProvider.html' },
 *          'iponweb': { url: '//bidswitch.com/vm2/udp.html'}
 *      },   
...
UserDataLoader.prototype = {
    ...
    /**
     * Load user data from a single vm2 partner.  Expects a request object that contains the following
     * properties:
     * <li>url {string}
    ...
    /**
     * Load user data from a multiple vm2 partners.  Expects a request object that contains the following
     * properties:
     * <li>timeout {number}
        ...
        var results = {},
            ...
            completionHandler = function(){
                if(--outstandingRequests === 0){
                    ...
                    request.responseHandler(undefined,results);
                }
            },
