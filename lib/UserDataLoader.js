...
UserDataLoader.prototype = {
     ...
     * <li>responseHandler {function}
     *      - mandatory node-compatible response handler function (function(error,result)); results
     *        is an object with keys representing partner names from the partners object and values
     *        containing either "result" Object properties or "error" strings</li>
     *
     * Example usage:
     * <pre><code>
     *  var udl = new UserDataLoader().loadAllUserData({
        ...
        var results = {},
            ...
            completionHandler = function(){
                if(--outstandingRequests === 0){
                    ...
                    results.rtime = new Date().getTime() - requestStartMs;
